...
console.log("Temperature of a city in degrees Celsius : "+cityTemp);

//2. Whether a customer has placed an order: true or false

let placedOrder: boolean = true;

console.log("Customer placed an order :"+ placedOrder);

//3. Person's phone number: "123-456-7890"
let phoneNumber:string="123-456-7890"
console.log("Person's phone number is : "+ phoneNumber)

//4.Amount of money in a customer's bank account: 1000.50

let accountBalance: number= 1000.50
console.log("Accont balance is :" + accountBalance)

//5.Person's email address: "john.doe@example.com"

let emailAdd:string="john.doe@example.com"
console.log("person's email address : "+ emailAdd)
...
let personIsMarried: boolean = false;

console.log("Person's marital status:", personIsMarried);
...
console.log("Favrite colour is "+ favouriteColour );
...
console.log("Number of employees in a company :"+ totalEmp);
